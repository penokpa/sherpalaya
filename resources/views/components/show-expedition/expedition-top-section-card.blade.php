<header class="card--rounded-none image-full bg-blue-100/50 h-[80dvh] relative">
    <figure class="h-[80dvh] w-full">
        <x-curator-glider class="h-[80dvh] w-full object-cover brightness-75" :media="$expedition->coverImage" fallback="default"
            loading="lazy" alt="{{ $expedition->title }} cover image"/>
    </figure>
