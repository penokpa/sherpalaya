...
return [
    ...
    */
    'profiles' => [
        // Sherpalaya default — curated set that covers 99% of real content-editing needs
        // without overwhelming Tashi with 50 buttons. Order matters; pipes are visual dividers.
        'default' => [
            'heading', '|',
    ...
    |
    */
    // Route media insertion through Curator so in-content images use the same library
    // as the rest of the admin and run through our auto-compress pipeline on upload.
