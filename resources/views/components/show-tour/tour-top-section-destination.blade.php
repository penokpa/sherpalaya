...
<div class="font-body">
    <div class="card-header  px-0 text-center" data-aos="fade-down" data-aos-duration="1200">
        <h5 class="card-title text-black font-oswald uppercase font-medium  tracking-tighter text-3xl">
            At a glimpse
        </h5>
    </div>
