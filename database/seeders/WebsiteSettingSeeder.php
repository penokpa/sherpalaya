...
class WebsiteSettingSeeder extends Seeder
{
    ...
    public function seedCompanySettings()
    {
        ...
        $companySetting->company_address_en = "Chandol, Ward No. 4, Kathmandu";
        $companySetting->company_address_fr = "Chandol, Ward No. 4, Kathmandu";

        $companySetting->company_email_en = "info@sherpalaya.com";
        $companySetting->company_email_fr = "info@sherpalaya.com";
