        ...
        <div class=" relative lg:flex lg:items-center ">
            ...
            <div id="navbar-mega-menu-click"
                ...
                <div
                    ...
                    {{-- Expeditions / Treks / Activities — direct links to listing pages --}}
                    <ul class="menu lg:menu-horizontal p-0 max-lg:w-fit bg-transparent">
                        <li class="hover:text-warning rounded-lg text-lg">
                            <a href="/{{ app()->currentLocale() }}/expeditions"
                                @class([
                                    'text-warning' => request()->routeIs('website.expeditions') || request()->routeIs('show_expedition'),
                                ])>
                        ...
                        <li class="hover:text-warning rounded-lg text-lg">
                            <a href="/{{ app()->currentLocale() }}/treks"
                                @class([
                                    'text-warning' => request()->routeIs('website.trekking') || request()->routeIs('show_trek'),
                                ])>
                                {{ __('navbar.treks') }}
                            </a>
                        </li>
                        <li class="hover:text-warning rounded-lg text-lg">
                            <a href="/{{ app()->currentLocale() }}/tours"
                                @class([
                                    'text-warning' => request()->routeIs('website.tours') || request()->routeIs('show_tour'),
                                ])>
